...
await conn.send2ButtonLoc(m.chat, await (await fetch(fla + "List+Menu")).buffer(), menubisnis, 'made with ❤️ by Agil Ussani Rahman', 'Pemilik Bot', `${_p}owner`, 'Donasi', `${_p}donasi`, m)
    ...
    await conn.send2ButtonLoc(m.chat, await (await fetch(fla + teks)).buffer(), text.trim(), 'made with ❤️ by Agil Ussani Rahman', 'Pemilik Bot', `${_p}owner`, 'Donasi', `${_p}donasi`, m)
  } catch (e) {
